...
void GLRAMTextureSurface::Paint(unsigned char* src_buffer, int src_row_span, const Awesomium::Rect& src_rect, const Awesomium::Rect& dest_rect) {
...
UITextureSurfaceFactory::UITextureSurfaceFactory() {
}

UITextureSurfaceFactory::~UITextureSurfaceFactory() {
}

Awesomium::Surface* UITextureSurfaceFactory::CreateSurface(Awesomium::WebView* view,
	int width,
	int height) {
	return new GLRAMTextureSurface(width, height);
}

void UITextureSurfaceFactory::DestroySurface(Awesomium::Surface* surface) {
